...
export default {
  ...
  show: {
    ...
    copy_as_markdown: '复制为Markdown',
    copy_as_markdown_tooltip: '复制页面内容为Markdown格式',
    copy_success: '复制成功',
    copy_failed: '复制失败',
  },
  catalog: '目录',
  ...
  save_as_draft: '另存为草稿',
  draft: '草稿',
  draft_tooltip: '草稿状态，仅自己可见',
  save_as_draft_tooltip: '保存为草稿后，该页面仅自己可见，其他成员无法查看',
  save_and_publish_tooltip: '发布后，该页面将对所有项目成员可见',
  ...
  mock_match_mode: '匹配方式',
  mock_exact_match: '精确匹配',
  mock_regex_match: '正则表达式',
  mock_regex_invalid: '正则表达式语法错误',
  mock_regex_tips: '正则匹配在精确匹配未命中时生效，按创建顺序匹配',
  help_document: '帮助说明',
